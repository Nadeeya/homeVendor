...
$selectQuery1 = "SELECT * FROM vendors WHERE shopName ='". $shopName."'";
    ...
    <section id="portfolio" class="portfolio">
      <div class="container" data-aos="fade-up">
        ...
        <div class="section-title">
          <h2>Welcome to <?php echo $shopName ?>'s page!</h2>
          <h5>Below are their current menu. Have fun browsing!</h5>       
        </div>
        <p style="text-align:center;"><?php echo $fetch['description']?></br>
        Contact them at <strong><?php echo $fetch['email']?></strong>
    </p>
